...
contract DeFIREEthBondDepository is Ownable {
    ...
    address public immutable treasury; // mints DeFIRE when receives principle
    ...
    struct Bond {
        uint payout; // DeFIRE remaining to be paid
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 DeFIRE ( underflow protection )
    ...
    /**
     *  @notice calculate current ratio of debt to DeFIRE supply
    ...
    /**
     *  @notice calculate amount of DeFIRE available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or DeFIRE) to the DAO
     *  @return bool
     */
